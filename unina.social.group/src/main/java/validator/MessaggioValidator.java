...
public class MessaggioValidator {
	...
	public void validateTesto(String testo) {
		if (testo == null || testo.isEmpty()) {
			throw new IllegalArgumentException("Il testo del messaggio non pu� essere nullo o vuoto.");
		}
		
		if (testo.length() > 3000) {
			throw new IllegalArgumentException("Il testo del messaggio � troppo lungo: il numero massimo di caratteri permessi � 3000.");
		}
	}
